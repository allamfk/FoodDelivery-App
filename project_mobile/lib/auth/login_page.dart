...
import 'package:project_mobile/auth/signup_page.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        makeInput(label: "Email", controller_val: cusername),
                        makeInput(
                            label: "Password",
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () {
                          signInUser(
                              update, cusername.text, cpassword.text, context);
                        },
...
void signInUser(Function(String text) update, String username, String password,
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse['status'] == 'Login successful') {
        final userId = jsonResponse['userId'].toString();
        final authProvider = Provider.of<AuthProvider>(context, listen: false);

        authProvider.login(userId, username, password);
